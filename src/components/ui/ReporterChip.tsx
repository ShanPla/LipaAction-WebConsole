...
// the English.
//
// Glyphs, not initials: the avatar used to print [VR] from [Verified
  ...
  if (reporter.identityWithheld) {
    return (
      <span className="inline-flex items-center gap-1.5 text-xs text-ink-500">
        <span aria-hidden className="flex h-5 w-5 items-center justify-center rounded-full bg-ink-100 text-[10px]">
          🔒
        </span>
        {t("reporter.withheld")}
      </span>
